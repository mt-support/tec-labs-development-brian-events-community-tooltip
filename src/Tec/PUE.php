...
class PUE extends Service_Provider {
	 ...
	 * @var string
	 */
	private static $pue_slug = 'extension-development-brian-events-community-tooltip';
	...
	public function register() {
		...
		$this->container->singleton( 'extension.development_brian_events_community_tooltip.pue', $this );
